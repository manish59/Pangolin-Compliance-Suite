...
from pangolin_sdk.connections.configs import APIConfig, AuthMethod
...
if __name__ == "__main__":
    ...
    test_api_connection_get()
    test_api_connection_post()
    test_api_connection_put()
    test_api_connection_patch()
    test_api_connection_delete()
